...
class EgoMotion:
    ...
    def calculate_egomotion(self, drawpoints=True, showtR=True):
        ...
        stereoProc = Process(target=stereo_scaler, args=(self.f1, self.f1, self.disp0, self.mapRx, self.mapRy, self.mapLx, self.mapLy, self.f, self.B, dzpipe, disppipe, self.stereo))
        stereoProc.start()
